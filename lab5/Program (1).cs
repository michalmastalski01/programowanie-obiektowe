...
class App
{
    ...
    {
        (int, int) point1 = (1, 10);
        Direction4 dir = Direction4.DOWN;
        Direction4 dir2 = Direction4.LEFT;
        var point2 = Exercise1.NextPoint(dir, point1, (10, 10));
        var point3 = Exercise1.NextPoint(dir2, point1, (10, 10));
...
class Exercise1
{
    public static (int, int) NextPoint(Direction4 direction, (int, int) point, (int, int) screenSize)
    {
        ...
        if(krotka.Item1 <= 0 || krotka.Item2 <= 0)
        {
            return (point.Item1, point.Item2);
        }
        else if(krotka.Item1 > screenSize.Item1 || krotka.Item2 > screenSize.Item2)
        {
            return (point.Item1, point.Item2);
        }
        return krotka;
