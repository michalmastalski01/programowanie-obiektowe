...
namespace lab4
{
    class App
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(tuple.Item1[0] + ", " + tuple.Item1[1]);
    ...
    public class Exercise2
    {
        ...
        {
            (string, int, bool) krotka = ("Karol", 12, true);
            return krotka;
        }
        ...
        {
            (T[] firstAndLast, bool isSame) krotka = new ValueTuple< T[], bool>();
            krotka.firstAndLast = new T[2];
            if (arr.Length == 0)
            {
                krotka = (Array.Empty<T>(), false);
                return krotka;
            }
            krotka.firstAndLast[0] = arr[0];
            Console.WriteLine(krotka.firstAndLast[0]);
            krotka.firstAndLast[1] = arr[arr.Length-1];
            Console.WriteLine(krotka.firstAndLast[1]);
            if (krotka.firstAndLast[0].Equals(krotka.firstAndLast[1])) krotka.isSame = true;
            else krotka.isSame = false;
            return krotka;
